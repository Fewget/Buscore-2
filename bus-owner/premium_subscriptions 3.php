...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'bus_owner') {
    error_log('User role not set or not bus_owner, redirecting to index');
...
<div class="modal fade" id="paymentConfirmationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You are about to purchase the <strong id="packageName"></strong> package for the following buses:</p>
                <ul id="selectedBusesList"></ul>
                <p class="fw-bold">Total Amount: Rs. <span id="totalAmount">0.00</span></p>
...
<div class="modal fade" id="termsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Premium Subscription Terms</h6>
                <p>By subscribing to our premium features, you agree to the following terms and conditions:</p>
                <ul>
...
<style>
    ...
    .package-card .btn .spinner-border {
        position: absolute;
        right: 10px;
        top: 50%;
