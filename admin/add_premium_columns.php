...
// Set page title
$page_title = 'Add Premium Columns';

// Include header
require_once __DIR__ . '/includes/header.php';

try {
    // Add premium feature columns to buses table
    ...
    echo "<div class='alert alert-success'>Premium feature columns added successfully!</div>";
